...
interface PatientSidebarProps extends React.HTMLAttributes<HTMLDivElement> {
  activeTab: string;
  onTabChange: (tab: string) => void;
}

export function PatientSidebar({ className, activeTab, onTabChange }: PatientSidebarProps) {
  const navItems = [
