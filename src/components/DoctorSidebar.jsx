...
export function DoctorSidebar({ className, activeTab, onTabChange, user }) {
  ...
  const secondaryNavItems = [
    ...
    { id: 'hospital-settings', label: 'Clinic Profile', icon: 'settings' },
  ];
    ...
    <aside className={cn(
      ...
      <div className="mt-auto pt-6 border-t border-emerald-50/50 dark:border-slate-800 space-y-3">
        ...
        <div 
          ...
          className={cn(
            "flex items-center gap-3 p-2 rounded-lg transition-colors cursor-pointer mb-2",
        ...
        >
          ...
          <div className="flex-1 min-w-0 text-left">
            <p className="text-sm font-bold truncate text-slate-900 dark:text-white">{user?.full_name || 'Loading...'}</p>
