...
const appointments = [
  { id: 1, type: 'Routine Checkup', mode: 'In-Person', time: 'Today, 2:00 PM', doctor: 'Dr. Sarah Jenkins', location: 'Room 302, Main Wing' },
  { id: 2, type: 'Cardiology Consult', mode: 'Telehealth', time: 'Oct 24, 9:00 AM', doctor: 'Dr. Emily Stone', location: 'Video Call Link Sent' },
];
  ...
  return (
    <div className="flex-1 space-y-6 p-8 pt-6 max-w-5xl mx-auto">
      <div className="flex items-center justify-between space-y-2">
        <h2 className="text-3xl font-bold tracking-tight text-slate-900">My Appointments</h2>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {appointments.map((apt) => (
          <Card key={apt.id} className="border-blue-100 shadow-sm shadow-blue-50">
            <CardHeader className="pb-3">
              ...
              <CardTitle className="text-xl">{apt.type}</CardTitle>
              <CardDescription className="text-base font-medium text-slate-900">{apt.doctor}</CardDescription>
            </CardHeader>
            <CardContent>
